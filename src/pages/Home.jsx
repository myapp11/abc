    ...
    <div style={{ height: "100vh", padding: "20px", backgroundColor: "#232323", color: "white" }}>
      ...
      <ul style={{ listStyle: "none", padding: "0" }}>
        <li style={{ marginBottom: "10px" }}>
          <Link
            to="/thermofisherscientificcorporatelandingpagecfour"
            style={{ color: "#87CEFA", textDecoration: "none" }}
          >
            ThermofisherScientificCorporateLandingPageCFour
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
        ...
        <li style={{ marginBottom: "10px" }}>
          <Link to="/thermofisherscientificcorporateinvestors" style={{ color: "#87CEFA", textDecoration: "none" }}>
            ThermofisherScientificCorporateInvestors
          </Link>
        </li>
        <li style={{ marginBottom: "10px" }}>
